...
public class ProjectConsumerHandler {
    ...
    public String getProjectDetail(@PathVariable("projectId") Integer projectId, ModelMap model) {
    ...
    public String saveConfirm(ModelMap modelMap, HttpSession session, MemberConfirmInfoVO memberConfirmInfoVO) {
        ...
        return "redirect:http://47.115.203.254/project/create/success";
    }
    ...
    public ResultEntity<String> uploadReturnPicture(
        ...
        // 1.执行文件上传
        ResultEntity<String> uploadReturnPicResultEntity = CrowdUtil.uploadFileToLocal(
                returnPicture.getInputStream(),
                returnPicture.getOriginalFilename(),
                fileUploadProperties.getOrginalPath(),
                fileUploadProperties.getInnerPath()
        );
        //将返回结果带上url头
        uploadReturnPicResultEntity.setData(fileUploadProperties.getUrl() + uploadReturnPicResultEntity.getData());
    ...
    public String saveProjectBasicInfo(
        ...
        ResultEntity<String> uploadHeaderPicResultEntity = CrowdUtil.uploadFileToLocal(
        ...
        if (ResultEntity.SUCCESS.equals(result)) {
            ...
            // 6.存入ProjectVO对象中
            projectVO.setHeaderPicturePath(fileUploadProperties.getUrl() + headerPicturePath);
        } else {
        ...
        // 二、上传详情图片
        // 1.创建一个用来存放详情图片路径的集合
        List<String> detailPicturePathList = new ArrayList<>(5);
        ...
        for (MultipartFile detailPicture : detailPictureList) {
            ...
            ResultEntity<String> detailUploadResultEntity = CrowdUtil.uploadFileToLocal(
            ...
            if (ResultEntity.SUCCESS.equals(detailUploadResult)) {
                ...
                // 8.收集刚刚上传的图片的访问路径
                detailPicturePathList.add(fileUploadProperties.getUrl() + detailPicturePath);
            } else {
...
//    public String testSave(@RequestParam(value = "testfile",required = false) MultipartFile testfile, HttpServletRequest request){
