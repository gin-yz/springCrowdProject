...
public class ProjectPO {
    ...
    private String rojectDescription;
    ...
    public String getRojectDescription() {
        return rojectDescription;
    }

    public void setRojectDescription(String rojectDescription) {
        this.rojectDescription = rojectDescription == null ? null : rojectDescription.trim();
    }
